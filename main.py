...
def main():
    ...
    if cfg.phase == 'train':
        ...
        # train_dataset=> <datasets.kitti_full.TrainDatasetWrapper object at 0x7fdb6529e640>
        # train_dataset[34]
        # return
        ...
        trainer = pl.Trainer(
            ...
            callbacks=[regular_ckpt_callback, best_ckpt_callback, progress_bar_callback]
                        if not cfg.debug else [progress_bar_callback],
